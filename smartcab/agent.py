...
class LearningAgent(Agent):
    ...
    def createQ(self, state):
        ...
        if self.learning:
            #print 'self.Q.keys(): {}'.format(self.Q.keys())
            ...
            #print 'self.Q[state][action]= {}'.format(self.Q[state][action])
        return 
    ...
    def choose_action(self, state):
        ...
        # When learning, choose a random action with 'build_state' probability
        ...
        # Otherwise, choose an action with the highest Q-value for the current state
            ...
            #action = temp.keys()[temp.values().index(self.get_maxQ(state))]
            possible_actions = [action for action in self.valid_actions if temp[action] == maxQ ]
    ...
    def learn(self, state, action, reward):
        ...
        #print 'q_state_action: {}'.format(self.Q[state][action])
        #print
        #print self.alpha
        if self.learning:
